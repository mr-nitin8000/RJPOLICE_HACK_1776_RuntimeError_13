...
if (isset($_SESSION['user_id']) && isset($_SESSION['user_email'])) {
    ...
    // echo "<br>";
    require "db_conn.php";
    $select = $conn->prepare('SELECT * FROM complaint_tb INNER JOIN users ON complaint_tb.u_id = users.id where  users.district=?');
    $select->execute([$_SESSION['user_district']]);
//   echo $user_id;
...
<body>
        ...
        <div class="active-cases-section-content">
            <div class="state-content">
                <div class="cases-heading">
                    Registered Cases in <?php echo $_SESSION['user_district']; ?> :
    ...
    <main class="mid-post">
        <div class="mid-post-content">
            <h2 class="mid-recent-heading">Recent Cases in <?php echo $_SESSION['user_district']; ?></h2>
            <div class="card-grid">
                <?php
$num = 0;
    foreach ($rows as $row): ?>
