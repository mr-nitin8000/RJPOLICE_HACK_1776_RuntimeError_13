...
.profile-card__img {
    ...
    position: relative;
    z-index: 4;
    box-shadow: 0px 5px 50px 0px #1e2022, 0px 0px 0px 7px #1e2022;
}
...
.profile-card__button.button--blue {
    ...
    box-shadow: 0px 4px 30px rgba(68, 92, 110, 0.4);
...
.profile-card__button.button--orange {
    background: #1e2022;
    box-shadow: 0px 4px 30px rgba(149, 118, 122, 0.35);
...
.icon-font {
    ...
    border: 2px solid black;
    border-radius: 20px;
    box-shadow: 2px 2px 8px rgb(57, 56, 56);
}
    ...
    <div class="wrapper">
        <div class="profile-card js-profile-card">
            <div class="profile-card__img">
                <img src="img/profile.png" alt="profile card" />
            </div>

            <div class="profile-card__cnt js-profile-cnt">
                <div class="profile-card__name">
                    <?php echo " " . $_SESSION['user_first_name'] . " " . $_SESSION['user_last_name']; ?></div>
                <div class="profile-card-loc">
                    ...
                    <span class="profile-card-loc__txt">
                        <?php echo " " . $_SESSION['user_state'] . ", " . $_SESSION['user_district']; ?> </span>
                </div>
                ...
                <div class="profile-card-inf">
                    ...
                    <div class="profile-card-inf__item">
                        <div class="profile-card-inf__title"><?php echo $_SESSION['user_reg_complaints']; ?></div>
                        <div class="profile-card-inf__txt">Complaints</div>
                    </div>
                ...
                <div class="profile-card-social">
                    <div>
                        <span class="icon-font"> <?php echo $_SESSION['user_email']; ?> </span>
                    </div>

                    <div class="contact">
                        <span class="icon-font1"> Contact: <?php echo $_SESSION['user_phone'] ?> </span>
                    </div>
                </div>
                ...
                <div class="profile-card-ctr">
                    ...
                    <button class="profile-card__button button--orange"><a href="logout.php" style="color:white"> Log
                            Out</a></button>
                </div>
            </div>
